...
class GSM8KDataset(Dataset):
    def __init__(self, data_path, tokenizer, max_samples=500):
        
        self.tokenizer = tokenizer
        data = load_dataset(data_path)
        self.data = data['train'].select(range(min(max_samples, len(data['train']))))
...
if __name__ == "__main__":
    ...
    # Use the Dataset directory in the project
    if platform.system() == 'Linux':
        prompts_dataset = GSM8KDataset('/home/hula0401/learning_llm/Datasets/gsm8k_chinese', tokenizer)
    elif platform.system() == 'Darwin':
        prompts_dataset = GSM8KDataset('./Dataset/gsm8k_chinese/data', tokenizer)
    else:
